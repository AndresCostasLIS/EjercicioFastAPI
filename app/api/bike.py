...
# CREATE
@router.post("/")
async def create_bike(data: BikeCreate, session: SessionDep):
...
# GET BY ID
@router.get("/{id}")
async def get_bike(id: int, session: SessionDep):
...
# DELETE
@router.delete("/{id}")
async def delete_bike(id: int, session: SessionDep):
...
@router.get("/")
async def get_bikes(session: SessionDep):
